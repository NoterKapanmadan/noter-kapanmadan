...
const url = 'https://cars-by-api-ninjas.p.rapidapi.com/v1/cars?fuel_type=diesel&limit=30';
const options = {
  method: 'GET',
  headers: {
...
export const createCarImage = (car) => {
  ...
  const getRandomLocation = () => {
    ...
    const locations = ["New York", "Chicago", "Los Angeles", "San Francisco", "Miami", "Ankara", "Amsterdam", "Berlin", "Paris", "London"];
